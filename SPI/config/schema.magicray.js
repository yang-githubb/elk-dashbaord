...
window.DASHBOARD_SCHEMAS.MAGICRAY = {
  ...
  kpi: {
    componentResultField: "confirmedresult.keyword",
    ...
    boardResultField: "sum_confirmed_result.keyword",
    boardGood: ["GOOD", "G"],
    boardPass: ["P", "PASS"],
    boardFail: ["F", "FAIL"],

    serialField: "source file.keyword",
    serialSourceFields: [
      "source file"
    ],
  ...
  detailSort: [
    ...
    { "componentname.keyword": { order: "asc" } }
  ],

  boardColumns: [
    { key: "serial", label: "Source File", type: "serial" },
